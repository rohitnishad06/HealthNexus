    ...
    <>
      ...
      <div className="row p-4" style={{ height: "92vh", background: "grey" }}>
        ...
        <div
          ...
          style={{ overflow: "auto" }}
        >
          <h4 className="my-5 text-center">Pending Appointment</h4>
                ...
                <tbody>
                  {
                    appointment.map((app,i) => (
                      ...
                      <td>{app.desc}</td>
                      <td>{app.status}</td>
                      <td><button className="btn btn-sm btn-danger" onClick={() => cancelapp(app._id)}>Cancel</button></td>
                      <td><button className="btn btn-sm btn-warning" onClick={() => accepptapp(app._id)}>Accept</button></td>
